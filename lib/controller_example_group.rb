...
module RSpec
  module Rails
    module ControllerExampleGroup
      ...
      # same as on_getting except set request format to text/plain
      def on_getting_text(page, parameters = {}, &block)
        on_getting(page, parameters.update(:format => :text), &block)
      end
